...
ApplicationWindow {
    ...
    Item {
        ...
        width: window.visibility === Window.FullScreen ? parent.width : Math.min(parent.width - 96, 1280)
        height: window.visibility === Window.FullScreen ? parent.height : Math.min(parent.height - 96, 960)
        ...
        Rectangle {
            ...
            Components.PcTopBar {
                ...
                onFullscreenToggleRequested: window.visibility = window.visibility === Window.FullScreen ? Window.Windowed : Window.FullScreen
                onCloseRequested: {
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    Loader {
                        anchors.fill: parent
                        sourceComponent: currentTab === "home" ? homePage : currentTab === "devices" ? devicesPage : currentTab === "settings" ? settingsPage : aboutPage
                    }
                }
            }
        }
    ...
    Component {
        id: aboutPage
        Components.PCAboutContent {
            themeTokens: window.themeTokens
            t: window.t
        }
    }

    component MenuButton: Control {
        id: menuButton
        ...
        property bool checked: window.currentTab === pageId
        background: Rectangle {
            radius: 14
            color: menuButton.checked ? window.themeTokens.sidebarActiveBackground : "transparent"
            border.color: menuButton.checked ? window.themeTokens.panelBorderColor : "transparent"
        }
        contentItem: RowLayout {
            ...
            Label {
                ...
                color: menuButton.checked ? window.themeTokens.accentGradientStart : window.themeTokens.textSecondary
                padding: 4
                background: Rectangle {
                    radius: 8
                    color: menuButton.checked ? "#260A84FF" : window.themeTokens.neutralBadgeBackground
                }
            }
        }
    ...
    component ControlButton: Control {
        id: controlButton
        property var iconComponent
        ...
        background: Rectangle {
            radius: 14
            color: controlButton.hovered ? controlButton.hoverColor : "transparent"
        }
        contentItem: RowLayout {
            anchors.fill: parent
            anchors.margins: 12
